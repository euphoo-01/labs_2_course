    ...
    void Analyze(In::IN &in, LT::LexTable &lextable, IT::IdTable &idtable) {
        ...
        while (i < in.size) {
            ...
            if (strchr(";,{}()+-*/=", in.text[i])) {
                ...
                switch (lexema) {
                    case ';': entry.lexema[0] = LEX_SEMICOLON;
                        break;
                    case ',': entry.lexema[0] = LEX_COMMA;
                        break;
                    case '{': entry.lexema[0] = LEX_LEFTBRACE;
                        break;
                    case '}': entry.lexema[0] = LEX_BRACELET;
                        break;
                    case '(': entry.lexema[0] = LEX_LEFTHESIS;
                        break;
                    case ')': entry.lexema[0] = LEX_RIGHTHESIS;
                        break;
                    case '+': entry.lexema[0] = LEX_PLUS;
                        break;
                    case '-': entry.lexema[0] = LEX_MINUS;
                        break;
                    case '*': entry.lexema[0] = LEX_STAR;
                        break;
                    case '/': entry.lexema[0] = LEX_DIRSLASH;
                        break;
                    case '=': entry.lexema[0] = '=';
                        break;
                }
